...
| [**presentation-docs**](presentation-docs/) | Transformer une note/texte/PPTX/PDF/DOCX en Markdown pour le mode présentation de Docs | [poppler](https://poppler.freedesktop.org/), python-pptx, [LiteParse](https://github.com/run-llama/liteparse) (selon le format d'entrée) |
