# Checklist de sécurité — les 12 domaines

Référentiel détaillé parcouru par le workflow d'audit (voir [`../SKILL.md`](../SKILL.md)). Pour chaque domaine, attribuer un statut **OK / KO / NA / Partiel** et, pour chaque **KO**, qualifier l'exploitabilité (voir [`rapport.md`](rapport.md)).
